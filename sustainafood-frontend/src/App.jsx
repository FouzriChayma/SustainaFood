...
import { AlertProvider } from "./contexts/AlertContext"; // Importez le contexte
...
import AlertDisplay from "./components/AlertDisplay"; // Importez le composant d'affichage des alertes

const App = () => {
  return (
    <AlertProvider>
      <AlertDisplay /> {/* Affichez les alertes globalement */}
      <Routes>
        {/* Public Routes */}
        ...
        {/* Private Routes for other roles */}
