...
const Profile = () => {
  ...
  const { user: authUser, token } = useAuth(); // Get user data from context
  // Use local state for optionally fetched/updated user info; initialize with authUser
  ...
  useEffect(() => {
    ...
    // Optionally fetch updated user info from the backend using authUser.id
          ...
          <div className="right-column">
            <div className="winner-cards">
              <div className="winner-outlinePage">
                <svg className="winner-icon winner-trophy" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="160" height="160">
              ...
              <div className="winner-detailPage">
                ...
                <div className="winner-gradesBox">
                  <svg className="winner-icon winner-gradesIcon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="60" height="60">
