...
// Styled component for pagination controls (same as RequestTable)
...
const DonationList = () => {
  ...
  const filteredDonations = donations.filter((donation) => {
    const expirationDateString = donation.expirationDate
      ? new Date(donation.expirationDate).toLocaleDateString()
      : "";
    const createdAtString = donation.createdAt
      ? new Date(donation.createdAt).toLocaleDateString()
      : "";
    const updatedAtString = donation.updatedAt
      ? new Date(donation.updatedAt).toLocaleDateString()
      : "";
    return (
